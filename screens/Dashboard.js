    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <View style={styles.center1}>
          ...
          <TouchableOpacity style={styles.icon} activeOpacity={0.5} onPress={() => this.onClickListener('ViewCart')}><Text style={styles.baseText}>Cart</Text>
          </TouchableOpacity>
        </View>

        <View style={styles.center}>
          <TouchableOpacity style={styles.icon} activeOpacity={0.5} onPress={() => this.onClickListener('ViewCategory')}><Text style={styles.baseText}>View Products</Text>
          </TouchableOpacity>
